...
const {selectAllRecipes, selectRecipesById, selectRecipesByUserId, insertRecipes, updateRecipes, deleteRecipes, countData, findUUID} = require('../model/recipes');
...
const recipesController = {
  ...
  insertRecipes: async (req, res) => {
    const {recipes_title, recipes_ingredients, users_id, recipes_video} = req.body;
